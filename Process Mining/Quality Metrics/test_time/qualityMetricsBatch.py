...
"""
    ...
    python qualityMetricsBatch.py model_metrics C:\\Users\\vcardenas.local\\qualityMetricsBatch\\test_time\\exp1_iter0_sf0.6_log_filtrado.csv test_time test_time  
    #########
